<template>
	<view>
		...
		<!-- 导航模块 -->
		<view class="nav">
			<navigator v-for="item in navList" :key="item.name" :url="item.navigator_url" :open-type="item.open_type || 'navigate'">
		...
		<view class="floor" v-for="(item,index) in floorList" :key="index">
			...
			<view class="floor_content">
				<navigator :url="item2.navigator_url" :open-type="item2.open_type" v-for="item2 in item.product_list" :key="item2.name">
